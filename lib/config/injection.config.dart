...
import '../core/network_services/network_info.dart' as _i4;
...
import '../data/datasources/remote_datasources/user_remote_datasource_impl.dart'
    as _i7;
import '../data/mappers/user_mapper.dart' as _i3;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i3.UserMapper>(() => _i3.UserMapper());
    gh.singleton<_i4.NetworkInfo>(() => _i4.NetworkInfoImpl());
    gh.singleton<_i5.ApiExecution>(
        () => _i5.ApiExecution(gh<_i4.NetworkInfo>()));
    ...
    gh.singleton<_i10.UserUseCase>(
        () => _i10.UserUseCase(gh<_i8.UserRepository>()));
    gh.singleton<_i11.UserBloc>(
        () => _i11.UserBloc(useCase: gh<_i10.UserUseCase>()));
    return this;
  }
}
